...
<div className="mt-5">
      ...
      <p className='mt-5 text-white font-100 text-3xl text-center'>Full Stack Developer</p>
        <div className="mt-10 mx-auto flex justify-center gap-x-3">
            ...
            <a href='../../assets/BRANDON 3.jpeg' Download className='p-3 font-bold text-gray-900 bg-blue-600 shadow shadow-blue-600'>Download CV <ArrowDownIcon className='h4 w-4 inline'/></a>
        </div>
    </div>
